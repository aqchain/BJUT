...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "aqchain.ipc", false, filepath.Join(os.TempDir(), "aqchain.ipc")},
		{"data", "aqchain.ipc", false, "data/aqchain.ipc"},
		{"data", "./aqchain.ipc", false, "./aqchain.ipc"},
		{"data", "/aqchain.ipc", false, "/aqchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "aqchain.ipc", true, `\\.\pipe\gttc.ipc`},
		{"data", "aqchain.ipc", true, `\\.\pipe\gttc.ipc`},
