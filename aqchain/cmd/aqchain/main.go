...
// aqchain is the official command-line client for GTTC.
package main
...
import (
	...
	"github.com/BJUT/aqchain/cmd/utils"
	"github.com/BJUT/aqchain/console"
	"github.com/BJUT/aqchain/eth"
	"github.com/BJUT/aqchain/ethclient"
	"github.com/BJUT/aqchain/internal/debug"
...
const (
	clientIdentifier = "aqchain" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the aqchain command line interface")
